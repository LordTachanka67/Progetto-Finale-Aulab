    ...
    <div class="container-fluid nav-text nav2">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
          ...
          @auth  
          <li class="nav-link">
            <button class="btn btn-quar" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasUser" aria-controls="offcanvasUser=">Ciao {{auth()->user()->name}} <i class="bi bi-person-circle"></i></button></li>
          @endauth
